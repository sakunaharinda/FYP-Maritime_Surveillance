...
class CTDetDataset_UCF24_Double(data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    img_path = self._imgpath + '/{:s}/{:05d}.jpg'.format(videoname, frame_num)

    ### To load the previous frame
    prev_frame_num = frame_num - 1
    prev_img_path = self._imgpath + '/{:s}/{:05d}.jpg'.format(videoname, prev_frame_num)
