...
class opts_flir(object):
  def __init__(self):
    self.parser = argparse.ArgumentParser()
    # basic experiment setting
    self.parser.add_argument('--task', default='ctdet_smd',
                             help='ctdet | ctdet_smd | ddd | multi_pose | exdet | double | track | sm | doublesm')
    self.parser.add_argument('--dataset', default='flir',
    ...
    self.parser.add_argument('--exp_id', default='coco_dla') # coco_dla for flir
