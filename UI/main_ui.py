...
"}")
        ...
        self.screen.setGeometry(QtCore.QRect(20, 50, 731, 411))
...
"")
        ...
        self.label_obj.setGeometry(QtCore.QRect(770, 10, 181, 31))
        font = QtGui.QFont()
        ...
        self.text_obj.setGeometry(QtCore.QRect(780, 50, 171, 161))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
...
"}")
        ...
        self.text_stat.setGeometry(QtCore.QRect(780, 370, 171, 91))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
...
"}")
        ...
        self.label_stat.setGeometry(QtCore.QRect(780, 340, 181, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
        ...
        self.label_vid.setGeometry(QtCore.QRect(290, 10, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
...
"")
        ...
        self.checkBox.setGeometry(QtCore.QRect(20, 470, 161, 31))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setPointSize(13)
        font.setBold(True)
...
"}")
        ...
        self.text_stat_2 = QtWidgets.QTextEdit(self.frame_main)
        self.text_stat_2.setGeometry(QtCore.QRect(780, 250, 171, 81))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        self.text_stat_2.setFont(font)
        self.text_stat_2.setStyleSheet("QTextEdit{\n"
"    \n"
"    color: rgb(255, 255, 255);\n"
"    border-style: outset;\n"
"    border-width: 2px;\n"
...
"    border-color:beige;\n"
"}")
        self.text_stat_2.setObjectName("text_stat_2")
        self.label_stat_2 = QtWidgets.QLabel(self.frame_main)
        self.label_stat_2.setGeometry(QtCore.QRect(780, 220, 181, 21))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setPointSize(11)
        self.label_stat_2.setFont(font)
        self.label_stat_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_stat_2.setObjectName("label_stat_2")
        self.radio_maritime = QtWidgets.QRadioButton(self.frame_main)
        self.radio_maritime.setGeometry(QtCore.QRect(800, 260, 91, 31))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.radio_maritime.setFont(font)
        self.radio_maritime.setStyleSheet("QRadioButton {\n"
"    color: rgb(100,100,100)\n"
"}\n"
"\n"
...
"    \n"
"}")
        self.radio_maritime.setChecked(True)
        self.radio_maritime.setObjectName("radio_maritime")
        self.radio_urban = QtWidgets.QRadioButton(self.frame_main)
        self.radio_urban.setGeometry(QtCore.QRect(800, 290, 131, 31))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.radio_urban.setFont(font)
        self.radio_urban.setStyleSheet("QRadioButton {\n"
"    color: rgb(100,100,100)\n"
"}\n"
"\n"
"QRadioButton::indicator{\n"
...
"    \n"
"}")
        self.radio_urban.setObjectName("radio_urban")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.checkBox.setText(_translate("mainWindow", "Enable Tracking"))
        self.label_stat_2.setText(_translate("mainWindow", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">Domain</span></p></body></html>"))
        self.radio_maritime.setText(_translate("mainWindow", "Maritime"))
        self.radio_urban.setText(_translate("mainWindow", "Urban Driving"))
