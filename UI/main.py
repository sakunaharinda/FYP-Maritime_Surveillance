...
"")
        ...
        self.text_obj.setGeometry(QtCore.QRect(780, 50, 171, 211))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
...
"}")
        ...
        self.text_stat.setGeometry(QtCore.QRect(780, 310, 171, 151))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
...
"}")
        ...
        self.label_stat.setGeometry(QtCore.QRect(770, 280, 181, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
